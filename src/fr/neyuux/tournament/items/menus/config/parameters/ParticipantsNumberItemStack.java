...
public class ParticipantsNumberItemStack extends CustomItemStack {

    private final Tournament tournament;

    public ParticipantsNumberItemStack() {
        ...
        this.setLore("§fPermet de modifier le nombre", "maximal de participants au Tournoi.", "", "§bValeur : §7§l" + this.tournament.getParticipants(), "", "§a>>Clique gauche pour ajouter", "§c>>Clique droit pour retirer", "§b>>Utiliser Shift pour modifier de 5");
    }
    ...
    public void use(HumanEntity player, Event event) {
        ...
        this.setLoreLine(3, "§bValeur : " + this.tournament.getParticipants());
