...
public enum Pays {
	...
	BRÉSIL("Brésil", "§2§lBr§e§lés§2§lil", "BR", "§2§lBrésil §f"),
	...
	PÉROU("Pérou", "§4§lPé§f§lr§4§lou", "PE", "§4Pé§fr§4ou §f"),
	...
	SUÈDE("Suède", "§3§lS§e§lu§3§lède", "SE", "§3S§e§lu§3ède §f"),
	TUNISIE("Tunisie", "§c§lTun§f§li§f§lsie", "TN", "§cTun§fi§fsie §f"),
	ÉGYPTE("Égypte", "§4§lÉg§f§lyp§8§lte", "EG", "§4Ég§fyp§8te §f"),
	NÉPAL("Népal", "§lNé§c§lp§f§la§c§ll", "NP", "§lNé§cp§fa§cl §f"),
	...
	CORÉE_DU_SUD("Corée du Sud", "§lCorée §9du §cSud", "KR", "§lCorée duSud §f"),
	ARABIE_SAOUDITE("Arabie Saoudite", "§2§lArabie Saoudite", "SA", "§2Arab. Saou. §f"),
	ESTONIE("Estonie", "§b§lEs§8§lton§f§lie", "EE", "§bEs§8ton§fie §f"),
	ÉTATS_UNIS("États-Unis", "§9§lÉtats-§c§lUnis", "US", "§c§lÉtatsUnis §f"),
	ALGÉRIE("Algérie", "§2§lAlg§4§lé§f§lrie", "DZ", "§2Alg§4é§frie §f"),
	PAYS_BAS("Pays-Bas", "§4§lPays§f-§1§lBas", "NL", "§1§lPays-Bas §f");
	
	Pays(String name, String displayname, String code, String scoreboardprefixname) {
		this.name = name;
	...
	public static Pays getByCode(String code) {
